...
if doTraining 
    ...
    net_UNET_baseline_3TWO=net;
    save net_UNET_baseline_3TWO net_UNET_baseline_3TWO;
    info_net_UNET_baseline_3TWO=info;
    save info_net_UNET_baseline_3TWO info_net_UNET_baseline_3TWO
